...
const Team = () => {
  return (
    <div>
      ...
      <a className="btn btn-square btn-primary m-1" href="#"><FontAwesomeIcon icon={faFacebookF} /></a>
      <a className="btn btn-square btn-primary m-1" href="#"><FontAwesomeIcon icon={faTwitter} /></a>
      <a className="btn btn-square btn-primary m-1" href="#"><FontAwesomeIcon icon={faInstagram} /></a>
      <a className="btn btn-square btn-primary m-1" href="#"><FontAwesomeIcon icon={faLinkedinIn} /></a>
    </div>
                                    </div>
                                </div>
